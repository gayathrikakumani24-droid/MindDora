    ...
    <div className="flex min-h-screen items-center justify-center bg-[#050816] p-4 relative overflow-hidden select-none">
      ...
      >
        ...
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-xs text-slate-400 font-medium">Continue your self-discovery & personal growth journey</p>
        </div>
        ...
        <div className="mt-8 text-center text-xs text-slate-400">
          ...
          <Link to="/register" className="font-extrabold text-[#00D4FF] hover:underline">
            Create Free Account
          </Link>
        </div>
      </motion.div>
